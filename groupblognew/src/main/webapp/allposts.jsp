...
<%
    ...
    List<Entity> blog = datastore.prepare(query).asList(FetchOptions.Builder.withDefaults());
    ...
    if (blog.isEmpty()) {
        ...
        for (Entity b : blog) {
         ...
         <span style="font-weight:bold;width:70%;font-family:Sans-serif;color:black;font-size:10pt;">
